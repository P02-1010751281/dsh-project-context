...
export const zh = {
	...
	"field.handoffThresholdRatioHint": "仅自适应关闭时生效；0.1–0.95，默认 0.75，早于 dsh 内置压缩的 0.8",
...
export const en: Record<SettingsCardKey, string> = {
	...
	"field.handoffThresholdRatioHint": "Only used when adaptive is off; 0.1–0.95, default 0.75, before dsh compaction's 0.8",
